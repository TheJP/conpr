...
public class ConCrawler {
    ...
    public void start() throws IOException {
        ...
        try (ServerSocket serverSocket = new ServerSocket(PORT)){
        	Executor e = new ThreadPoolExecutor(10, 100, 1, TimeUnit.MINUTES, new ArrayBlockingQueue<Runnable>(500), new ThreadFactory() {
        		private AtomicInteger number = new AtomicInteger(1);
				@Override
				public synchronized Thread newThread(Runnable r) {
					return new Thread(r, "ConCrawler-ConnectionHandler-" + number.incrementAndGet());
				}
			});
            while (true) {
